...
def main(dataset_name, dataset_id):
    ...
    automl = autosklearn.classification.AutoSklearnClassifier(
        ...
        tmp_folder=os.path.join(os.environ["TMPDIR"], "tmp"),
        output_folder=os.path.join(environ["TMPDIR"], "output"),
...
if __name__ == '__main__':
    ...
    os.environ['THEANO_FLAGS'] = os.path.join(os.environ["TMPDIR"], "compile")
